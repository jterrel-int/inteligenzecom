    ...
    <section className="py-24 md:py-32 border-y border-border">
      <div className="max-w-6xl mx-auto px-6">
        <AnimatedSection>
          ...
          <h2 className="text-3xl md:text-4xl leading-tight mb-16 text-center max-w-2xl mx-auto">Benchmarks que importan</h2>
        </AnimatedSection>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {metrics.map((m, i) => (
            <AnimatedItem key={i} delay={i * 0.1}>
              <div className="text-center">
                <span className="text-4xl md:text-5xl font-heading text-primary block mb-3">{m.value}</span>
