...
const benefits = [
  {
    label: "Medición ambiental clara",
    food: "Agua, energía, residuos orgánicos, emisiones de procesos",
    mining: "Emisiones fugitivas, uso de agua, relaves, biodiversidad",
    transport: "Consumo de combustible, emisiones CO₂, rutas optimizadas",
  },
  {
    label: "Cumplimiento normativo",
    food: "Regulaciones de inocuidad, calidad y emisiones",
    mining: "Estándares de seguridad e impacto ambiental",
    transport: "Normativas de emisiones y condiciones laborales",
  },
  {
    label: "Reporte social y gobernanza",
    food: "Condiciones laborales, salud ocupacional, trazabilidad",
    mining: "Seguridad, ética y bienestar del personal",
    transport: "Comunidades, derechos humanos, transparencia",
  },
  {
    label: "Decisiones basadas en datos",
    food: "Puntos de mejora en producción más limpia",
    mining: "Uso eficiente de recursos e impacto ambiental",
    transport: "Optimización de flotas y mantenimiento preventivo",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <img
              src={flowDiagram}
              alt="Diagrama de flujo de integración de datos"
